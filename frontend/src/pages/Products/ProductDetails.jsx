  ...
  return (
    <>
      ...
      {isLoading ? (
        ...
        <>
          <div className="flex flex-col lg:flex-row gap-12 mt-[2rem] ml-[10rem]">
            <div className="flex-shrink-0">
              <img
                src={product.image}
                alt={product.name}
                className="w-full lg:w-[40rem] md:w-[30rem] sm:w-[20rem] rounded-lg object-contain"
              />
            </div>

            <div className="flex flex-col justify-start max-w-[40rem]">
              ...
              <div className="flex justify-between items-center mt-4">
                ...
                <div className="relative  mb-10 -mr-1"> 
